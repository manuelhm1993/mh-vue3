...
<template>
    <MainComponent>
        <h1 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl lg:text-5xl dark:text-white">Esta es la página de inicio</h1>
